		...
		<header id="masthead" class="site-header">
			<div class="container flex">
				<div class="site-branding">
					...
					$open_sky_mental_health_description = get_bloginfo('description', 'display');
					if ($open_sky_mental_health_description || is_customize_preview()) :
					?>
						<p class="site-description"><?php echo $open_sky_mental_health_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
													?></p>
					<?php endif; ?>
				</div><!-- .site-branding -->
				...
				<nav id="site-navigation" class="main-navigation">
					<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
						...
						<?php esc_html_e('', 'open-sky-mental-health'); ?></button>
					<?php
					wp_nav_menu(
						array(
